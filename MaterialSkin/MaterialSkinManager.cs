...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        private static readonly Color BACKGROUND_LIGHT = Color.FromArgb(255, 185, 185, 185);
        ...
        private static readonly Color BACKGROUND_WHITE = Color.FromArgb(255, 205, 205, 205);
        private static Brush BACKGROUND_WHITE_BRUSH = new SolidBrush(BACKGROUND_WHITE);
